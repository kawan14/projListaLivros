...
namespace projLivrosLista
{
    class Program
    {
        ...
        #region  2. Pesquisar livro (sintético)
        ...
        #region 3. Pesquisar livro (analítico)
